...
grafo_malla.generar_arbol_dfsr_gv("1-0", "arbol_dfsr_malla30.gv")
grafo_malla.generar_arbol_dfsi_gv("0-1", "arbol_dfsi_malla30.gv")
...
grafo_erdos.generar_arbol_dfsr_gv(2, "arbol_dfsr_erdos30.gv")
grafo_erdos.generar_arbol_dfsi_gv(1, "arbol_dfsi_erdos30.gv")
...
grafo_gilbert.generar_arbol_dfsr_gv(2, "arbol_dfsr_gilbert30.gv")
grafo_gilbert.generar_arbol_dfsi_gv(1, "arbol_dfsi_gilbert30.gv")
...
grafo_geo.generar_arbol_dfsr_gv(2, "arbol_dfsr_geo30.gv")
grafo_geo.generar_arbol_dfsi_gv(1, "arbol_dfsi_geo30.gv")
...
grafo_barabasi.generar_arbol_dfsr_gv(2, "arbol_dfsr_barabasi30.gv")
grafo_barabasi.generar_arbol_dfsi_gv(1, "arbol_dfsi_barabasi30.gv")
